...
struct Client *search_client(char* key)
{
   ...
   {
	   //printf("To hash einai %s enw to key einai %s\n",hashArray[hashIndex]->key, key);
...
//	int result=0;
//	int hashIndex=0;
//	for(hashIndex=0; hashIndex<MAX_CLIENTS; hashIndex++)
//	{
//		if(hashArray[hashIndex]!=NULL)
//		{
//			if(hashArray[hashIndex]->key!=NULL)
//			{
//				result=strcmp(hashArray[hashIndex]->key,client_name);
//			}
//		}
//	}
	if(client!=NULL)
...
//struct Client *search_clientNEW(char* key)
//{
//	int hashIndex=0;
//
//	for(hashIndex=0;hashIndex<MAX_CLIENTS; hashIndex++)
